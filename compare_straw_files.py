...
def compute_spearman(matrix1, matrix2):
    """
...
def process_chromosome(file1, file2, resolution, chrom_length, bin_size, output_file):
    """
    ...
    with open(output_file, 'w') as out_file:
        ...
        for start in range(0, chrom_length, bin_size):
            ...
            try:
                ...
                # Compute Spearman correlation
                spearman_corr = compute_spearman(matrix1, matrix2)
...
def main(args):
    ...
    process_chromosome(args.file1, args.file2, args.resolution, args.chrom_length, args.bin_size, args.output)
